...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d,Conv_att, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 SPP, SPPF, SPPCSPC,SPPCSPC_att,SPPCSPC_sa,GhostSPPCSPC, MixConv2d, Focus, Stem, GhostStem, CrossConv,
                 ...
                 Yolov7x_E_ELAN,Yolov7_E_ELAN_R,Yolov7_E_ELAN_R12,Yolov7_E_ELAN_RR,fusion2,fusion3,Yolov7_E_ELAN_RR_3, Yolov7_E_ELAN_RR_m]:
            c1, c2 = ch[f], args[0]
            if c2 != no:  # if not output
                c2 = make_divisible(c2 * gw, 8)

            args = [c1, c2, *args[1:]]
            if m in [DownC, SPPCSPC,SPPCSPC_att, GhostSPPCSPC,
        ...
        # elif m is Shortcut_conv:
        #     c1 = ch[f]
        #     c2 = 2 * args[0]
        #     args = [c1, args[0]]
        #
        # elif m is V7DownSampling_Neck_shortcut:
        #     c1 = ch[f]
        #     c2 = 2 * args[0]
        #     args = [c1, args[0]]
            ...
            c2 = 2 * args[0] + ch[f[1]]
            args = [c1, args[0]]
        elif m is V7DownSampling_Neck_shortcut_att:
            c1 = ch[f[0]]
            c2 = 2 * args[0] + ch[f[1]]
            args = [c1, args[0]]
